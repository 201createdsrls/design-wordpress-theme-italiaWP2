...
<?php if( getContrastRatio($color_10) < 0.70 || getContrastRatio($color_10) >= 2.60 ) : ?>
...
<?php if( getContrastRatio($color_20) < 0.80 || getContrastRatio($color_20) >= 3.50 ) : ?>
...
<?php if( getContrastRatio($main_color) >= 0.90 && getContrastRatio($main_color) < 2.70 ) : ?>
...
<?php if( getContrastRatio($color_80) >= 0.90 && getContrastRatio($color_80) < 2.50 ) : ?>
...
<?php if( getContrastRatio($color_80) >= 0.90 && getContrastRatio($color_80) < 2.50 && getContrastRatio($color_98) <= 4.00 ) : ?>
